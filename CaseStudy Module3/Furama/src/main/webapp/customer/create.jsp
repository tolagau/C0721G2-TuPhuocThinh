                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form class="col-12" method="post">
                            ...
                            <%--                             </div>--%>
                                <div class="form-group col-12">
                                    <label class="col-12 float-left mt-1" for="exampleInputPosition">customerType:</label>
                            ...
                            <div class="form-group col-12">
                                <label class="col-12 float-left" for="exampleInputIDCARD">Gender:</label>
                                <input type="text" name="gender" class="form-control col-12 float-left mt-2"
                                       id="exampleInputIDCARD" placeholder="Enter ID CARD">
                            </div>
                            <div class="form-group col-12">
                                <label class="col-12 float-left" for="exampleInputSALARY">idCard:</label>
